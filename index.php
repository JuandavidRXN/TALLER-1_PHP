    ...
    <main>
        ...
        <div class="col-4">
            <form action="index.php" method="POST">
                ...
                <div class="col">
                  <input type="number" class="form-control" placeholder="precio6" name="precio6">
                </div>
                </div>

                
                    <button type="submit" class="btn btn-danger btn-block" name="boton">Comprar</button>
...
echo("PRODUCTO PRIMER--->".$producto1."---->".$precio1);
echo("<br>");
echo("PRODUCTO SEGUNDO--->".$producto2."---->".$precio2);
echo("<br>");
echo(" PRODUCTO TERCER--->".$producto3."---->".$precio3);
echo("<br>");
echo("PRODUCTO CUARTO--->".$producto4."---->".$precio4);
echo("<br>");
echo("PRODUCTO QUINTO--->".$producto5."---->".$precio5);
echo("<br>");
echo("PRODUCTO SEIS---->".$producto6."------>".$precio6);
echo("-----------------------------------------------------------");
